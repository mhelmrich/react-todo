...
var dummyData = [{ taskText: "Learn about React", completed: true }, { taskText: "Finish todo project", completed: false }, { taskText: "Horizons speaker series", completed: false }];
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.todos.map(function (item, index) {
          return _react2.default.createElement(_Todo2.default, { key: index, task: item.taskText, completed: item.completed,
